...
DROP TABLE IF EXISTS api_key_stats;
DROP TABLE IF EXISTS api_key_events;
DROP MATERIALIZED VIEW IF EXISTS export_stats;
DROP TABLE IF EXISTS auth_logs;
DROP MATERIALIZED VIEW IF NOT EXISTS auth_stats;
DROP TABLE IF EXISTS export_events;
DROP MATERIALIZED VIEW IF NOT EXISTS sync_stats;
DROP TABLE IF EXISTS sync_events;
DROP MATERIALIZED VIEW IF NOT EXISTS daily_stats;
